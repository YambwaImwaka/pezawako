                    ...
                    children: [
                      Form(
                        ...
                        child: Column(
                          children: [
                            ...
                            InputField(
                              placeholder: context.lwTranslate.emailOrUsername,
                      ...
                      Center(
                        child: TextButton(
                          ...
                          child: Text(context.lwTranslate.forgotPassword),
                        ),
                      ),
                      Divider(
                      ...
                      if (configItem('social_logins.google.enable'))
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: SocialLoginButton(
                            text: context.lwTranslate.signInWithGoogle,
