...
class MessengerChatListPage extends StatefulWidget {
  const MessengerChatListPage({super.key, required this.sourceElement});
                  ...
                  onTap: () => navigatePage(
                    ...
                    ProfileDetailsPage(
                      userProfileItem: {
                        ...
                        'user_uid': widget.sourceElement['user_uid'] ?? '',
                      },
                    ),
                  ),
                  child: Padding(
                ...
                if (value == 'delete_all_chat') {
                  showActionableDialog(context,
                      description: Text(context
                          .lwTranslate.doYouWantToDeleteAllTheChatMessageOf),
                      onConfirm: () {
                    data_transport.post(
                      ...
                      confirmActionText: context.lwTranslate.yes,
                      cancelActionText: context.lwTranslate.no);
                }
              },
              ...
              itemBuilder: (BuildContext context) {
                return [
                  PopupMenuItem<String>(
                    ...
                    child: Text(context.lwTranslate.deleteAllChatHistory),
                  )
                ].toList();
              },
            ),
  ...
  subscribeChannelForChat() {
    FBroadcast.instance().register('local.broadcast.user_channel',
          ...
          if (receivedData['messageRequestStatus'] != null) {
            setState(() {
              userData['messageRequestStatus'] = receivedData['messageRequestStatus'];
            });
          }
                    ...
                    ? Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text(context.lwTranslate.loadingMessages),
                            ),
                          ],
                        ),
                      )
                            ...
                            if (!stickerData['is_purchased'] &&
                              ...
                              showActionableDialog(context,
                                  ...
                                  description: Text(context.lwTranslate
                                      .youWantToPurchaseThisStickerItWillCostYou(
                                          stickerData['formatted_price'])),
                                  onConfirm: () {
                                data_transport.post(
