...
class _UsersListPageState extends State<UsersListPage>
    ...
    data_transport
        ...
        .then((dataReceived) {
          setState(() {
            ...
            items =
                getItemValue(dataReceived, 'data.filterData') ??
  ...
  void _updateTempFindFilterData(
  ...
  void _loadMore() {
    if (urlToCall != dataResponse['nextPageUrl'] &&
      ...
      data_transport.get(urlToCall, queryParameters: tempFilterInputData).then((
        dataReceived,
      ) {
        setState(() {
          dataResponse = getItemValue(dataReceived, 'data');
    ...
    return Scaffold(
      ...
      floatingActionButton:
          (widget.title == null)
              ...
              : null,
      body:
          ((getItemValue(dataResponse, 'userRequestType') == 'who_liked_me') &&
                        ...
                        if (items.isEmpty && !isRequestProcessing) {
                          ...
                          return const Card(
                            ...
                            child: Padding(
                              ...
                              child: AppItemProgressIndicator(size: 20),
                            ),
                          );
                        } else {
    ...
    return showModalBottomSheet<void>(
      ...
      builder: (BuildContext context) {
        ...
        List<Widget> filterTabs = [
          Tab(text: context.lwTranslate.basic),
          Tab(
        ...
        tempFilterInputData['username'] =
            (basicFilterData['username'] != null)
        ...
        tempFilterInputData['distance'] =
            (basicFilterData['distance'] != null)
        ...
        getItemValue(dataResponse, 'userSettings.preferred_language').forEach((
          itemOptionKey,
          itemOptionValue,
        ) {
          bool? isChecked =
              tempFilterInputData.containsKey('language') &&
                  ...
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      if (value == true) {
                        ...
                        if (tempFilterInputData['language'].contains(
                          itemOptionKey,
                        )) {
        ...
        getItemValue(dataResponse, 'userSettings.relationship_status').forEach((
          itemOptionKey,
          itemOptionValue,
        ) {
          bool? isChecked =
              tempFilterInputData.containsKey('relationship_status') &&
              tempFilterInputData['relationship_status'].contains(
                itemOptionKey,
              );
          filterPersonalChildren.add(
            StatefulBuilder(
                  ...
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      if (value == true) {
                        ...
                        if (tempFilterInputData['relationship_status'].contains(
                          itemOptionKey,
                        )) {
        ...
        getItemValue(dataResponse, 'userSettings.work_status').forEach((
          itemOptionKey,
          itemOptionValue,
        ) {
          bool? isChecked =
              tempFilterInputData.containsKey('work_status') &&
                  ...
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      if (value == true) {
                        ...
                        if (tempFilterInputData['work_status'].contains(
                          itemOptionKey,
                        )) {
        ...
        getItemValue(dataResponse, 'userSettings.educations').forEach((
          itemOptionKey,
          itemOptionValue,
        ) {
          bool? isChecked =
              tempFilterInputData.containsKey('education') &&
                  ...
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      if (value == true) {
                        ...
                        if (tempFilterInputData['education'].contains(
                          itemOptionKey,
                        )) {
        ...
        List<Widget> filterTabViews = [
          ...
          Padding(
            ...
            child: SingleChildScrollView(
              child: Column(children: filterChildren),
            ),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: SingleChildScrollView(
              child: Column(children: filterPersonalChildren),
            ),
          ),
        ];
        specificationDataSettings.forEach((
          ...
          if ((specificationItemIndex != 'favorites')) {
            if (!specificationSelectedCount.containsKey(
              specificationItemIndex,
            )) {
            ...
            specificationItem['items'].forEach((
              itemOptionKey,
              itemOptionValue,
            ) {
              if (itemOptionKey == 'height') {
                ...
                if (itemOptionValue['options'] != null) {
                  itemOptionValue['options'].forEach((
                    subOptionKey,
                    subOptionValue,
                  ) {
                    bool? isChecked =
                        tempFilterInputData.containsKey(itemOptionKey) &&
                        tempFilterInputData[itemOptionKey].contains(
                          subOptionKey,
                        );
                    filterChildren.add(
                      StatefulBuilder(
                          ...
                          return CheckboxListTile(
                            ...
                            onChanged: (bool? value) {
                              ...
                              if (value == true) {
                                ...
                                if (tempFilterInputData[itemOptionKey].contains(
                                  subOptionKey,
                                )) {
                                  tempFilterInputData[itemOptionKey]
                                      .removeWhere(
                                        (removeValue) =>
                                            removeValue == subOptionKey,
                                      );
                                  specificationSelectedCount[specificationItemIndex] =
                                      (specificationSelectedCount[specificationItemIndex]! -
                                          1);
        ...
        tabController = TabController(length: filterTabs.length, vsync: this);
              ...
              appBar: AppBar(
                ...
                actions: [
                  TextButton(
                    child: const Row(
                      children: [
                        Icon(CupertinoIcons.clear, size: 14),
                        Text(
                          'Clear all Filters',
                  ...
                  TextButton(
                    child: Row(
                      children: [
                        const Icon(CupertinoIcons.check_mark, size: 24),
                        Text(
  ...
  Widget _badgeCount(
    ...
    return specificationSelectedCount.containsKey(specificationItemIndex) &&
        ...
        ? badges.Badge(
          ...
          child: Text(specificationItem['title']),
        )
...
class UserFindFilter extends StatelessWidget {
  const UserFindFilter({super.key});
