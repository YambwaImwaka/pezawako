  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: mainAppBarWidget(
          title: context.lwTranslate.myProfileUpdate,
          context: context,
          actionWidgets: []),
      body: FutureBuilder(
          future: _fetchMyData,
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            ...
            List<Widget> tabItems = [
              Padding(
                ...
                child: Tab(text: context.lwTranslate.basicInformation),
              ),
            ];
            // fixed tab views
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SelectField(
                      ...
                      labelText: context.lwTranslate.language,
                      onChanged: (String? value) {
                    ...
                    InputField(
                      ...
                      labelText: context.lwTranslate.aboutMe,
                      onChanged: (String? value) {
                        _updateBasicInfo(context, 'about_me', value);
                      },
                    ),
                    DateTimeInputPicker(
                      initialValue: (basicUserInformationFormInputs['birthday']
                                  .toString() ==
                              'null')
                          ? ''
                          : basicUserInformationFormInputs['birthday']
                              .toString(),
                    ...
                    SelectField(
                      ...
                      labelText: context.lwTranslate.education,
                      onChanged: (String? value) {
                    ...
                    SelectField(
                      ...
                      labelText: context.lwTranslate.relationshipStatus,
                      onChanged: (String? value) {
                    ...
                    SelectField(
                      ...
                      labelText: context.lwTranslate.workStatus,
                      onChanged: (String? value) {
                ...
                data['data']['specifications']
                  ...
                  for (var item in itemOptions) {
                    if ((!formInputData.containsKey(item['name']))) {
                      formInputData[item['name'].toString()] =
              ...
              children = <Widget>[
                ...
                Padding(
                  ...
                  child: Text(context.lwTranslate
                      .errorError(snapshot.error.toString())),
                ),
              ];
            } else {
              children = <Widget>[
  ...
  EasyAutocomplete locationUpdateWidget(BuildContext context) {
    return EasyAutocomplete(
        decoration: InputDecoration(
            labelText: context.lwTranslate.location,
...
class BasicInfoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Center(
          child: Text(context.lwTranslate.yourBasicInformationFormWillComeHere),
        )
      ],
    );
  }
