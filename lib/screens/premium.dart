...
class PremiumPageState extends State<PremiumPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: Text(context.lwTranslate.premium),
      ),
      body: !isLoaded
                ...
                child: Column(
                  children: [
                    ...
                    if (premiumData['isPremiumUser'])
                      Column(
                        children: [
                          Text(context.lwTranslate.youArePremiumUser),
                          const Divider(
                            height: 20,
                            thickness: 0.01,
                          ),
                          Text(
                            context.lwTranslate.premiumMembershipExpiry,
                            style: TextStyle(
                            ...
                            onPressed: (() {
                              if (selectedPackage == null) {
                                showActionableDialog(context,
                                    title: context.lwTranslate.selectPlan,
                                    description: Text(
                                        context.lwTranslate.pleaseSelectAPlan),
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                premiumData['isPremiumUser']
                                    ? context
                                        .lwTranslate.extendPremiumMembership
                                    : context.lwTranslate.bePremiumNow,
